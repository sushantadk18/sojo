...
public final class ActivityPost1Binding implements ViewBinding {
  ...
  private ActivityPost1Binding(@NonNull ConstraintLayout rootView, @NonNull Button button3,
      ...
      @NonNull EditText editTextTextPersonName4, @NonNull TextView textView11,
  ...
  @NonNull
  public static ActivityPost1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPost1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_post1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPost1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPost1Binding((ConstraintLayout) rootView, button3, editTextTextPersonName,
          editTextTextPersonName10, editTextTextPersonName2, editTextTextPersonName3,
