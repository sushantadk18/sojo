...
public final class ActivityPostEditBinding implements ViewBinding {
  ...
  private ActivityPostEditBinding(@NonNull ConstraintLayout rootView, @NonNull Button button3,
  ...
  @NonNull
  public static ActivityPostEditBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPostEditBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_post_edit, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPostEditBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPostEditBinding((ConstraintLayout) rootView, button3,
          editTextTextPersonName, editTextTextPersonName10, editTextTextPersonName2,
          editTextTextPersonName3, editTextTextPersonName4, textView11, textView2, textView3,
