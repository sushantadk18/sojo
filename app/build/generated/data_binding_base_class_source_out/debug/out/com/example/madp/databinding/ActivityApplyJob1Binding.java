...
public final class ActivityApplyJob1Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityApplyJob1Binding(@NonNull ConstraintLayout rootView, @NonNull Button button3,
      @NonNull Button button4, @NonNull Button button5, @NonNull Button button6,
      @NonNull Button button8, @NonNull EditText editTextTextPersonName2,
      @NonNull EditText editTextTextPersonName4, @NonNull TextView textView12,
  ...
  @NonNull
  public static ActivityApplyJob1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityApplyJob1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_apply_job1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityApplyJob1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityApplyJob1Binding((ConstraintLayout) rootView, button3, button4, button5,
          button6, button8, editTextTextPersonName2, editTextTextPersonName4, textView12,
          textView13, textView14, textView15, textView16, textView17, textView18, textView19,
          textView20, textView21, textView6);
    }
