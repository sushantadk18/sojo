...
public final class ActivityRegister1Binding implements ViewBinding {
  ...
  private ActivityRegister1Binding(@NonNull ConstraintLayout rootView, @NonNull Button button3,
  ...
  public static ActivityRegister1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_register1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityRegister1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegister1Binding((ConstraintLayout) rootView, button3,
          editTextTextPersonName, editTextTextPersonName2, editTextTextPersonName3,
          editTextTextPersonName4, textView2, textView3, textView4, textView5, textView6);
    }
